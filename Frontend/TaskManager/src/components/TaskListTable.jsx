...
const TaskListTable = ({ tableData }) => {
  ...
  switch (status) {
   ...
   const getPriorityBadgeColor = (priority) => {
    switch (priority) {
        case 'High' : return 'bg0red-100  text-red-500 border border-red-200';
        ...
        default: return 'bg-gray-100 text-gray-500 border boredr-gray-200';
    }
   };
  ...
  <table className="min-w-full">
    ...
    <tbody>
      {tableData.map(( task ) => (
        <tr key={task._id} className="boeder-t border-gray-200">
